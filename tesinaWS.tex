...
\lstinputlisting[style=java, firstline=68, lastline=103]{./src/JenaModel/JenaModel.java}

Prima di tutto viene richiamata la seguente funzione:

\lstinputlisting[style=java, firstline=228, lastline=236]{./src/JenaModel/JenaModel.java}
...
\lstinputlisting[style=java, firstline=105, lastline=198]{./src/JenaModel/JenaModel.java}
...
\lstinputlisting[style=java, firstline=253, lastline=268]{./src/JenaModel/JenaModel.java}
...
\lstinputlisting[style=java, firstline=213, lastline=225]{./src/JenaModel/JenaModel.java}
